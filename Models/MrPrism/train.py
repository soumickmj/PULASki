...
'''refuge'''
train_dataset = REFUGEDataset(args, args.data_path, transform = transform_train, transform_seg = transform_train_seg, mode = 'Train')
...
for epoch in range(settings.EPOCH):
    if args.mod == 'rec':
        ...
        loss = function.train_rec(args, net, optimizer, nice_train_loader, epoch, writer, vis = args.vis)
